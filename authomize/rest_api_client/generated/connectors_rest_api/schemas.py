...
#   timestamp: 2023-11-30T10:23:19+00:00
...
class NewAssetRequestSchema(BaseModel):
    ...
    customParameters: Optional[List[CustomParameters]] = Field(
        default=[], description='custom connector parameters', title='Customparameters'
    )
    tags: Optional[List[constr(min_length=1)]] = Field(
        default=None, description='Tags associated with the asset.\n', title='Tags'
    )
