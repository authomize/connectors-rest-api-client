...
#   timestamp: 2023-08-29T11:28:06+00:00
...
class AuthomizeRestApiClientGeneratedConnectorsRestApiSchemasUserStatus(Enum):
    Staged = 'Staged'
    Enabled = 'Enabled'
    Disabled = 'Disabled'
    Suspended = 'Suspended'
...
class AuthomizeSdkSchemaIdentitiesIdentityModelsUserStatus(Enum):
    Staged = 'Staged'
    Enabled = 'Enabled'
    Disabled = 'Disabled'
    Suspended = 'Suspended'
...
class CampaignUserSchema(BaseModel):
    ...
    status: Optional[AuthomizeSdkSchemaIdentitiesIdentityModelsUserStatus] = Field(
        default=None,
...
class IdentityDescription(BaseModel):
    ...
    status: Optional[AuthomizeSdkSchemaIdentitiesIdentityModelsUserStatus] = None
    service: Optional[str] = Field(default=None, title='Service')
