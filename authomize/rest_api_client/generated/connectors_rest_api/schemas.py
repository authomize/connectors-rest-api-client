...
#   timestamp: 2024-01-21T07:28:07+00:00
...
class AppSchema(BaseModel):
    ...
    integrationName: Optional[str] = Field(default=None, title='Integrationname')
...
class AssetTypes(Enum):
    ...
    Resource_ApplicationPrincipal = 'Resource_ApplicationPrincipal'
...
class CustomProperties(BaseModel):
    key: str = Field(..., description='Name of the parameter', title='Key')
    value: constr(max_length=64) = Field(
        ..., description='Value of the Parameter', title='Value'
    )
...
class NewAssetRequestSchema(BaseModel):
    ...
    customProperties: Optional[List[CustomProperties]] = Field(
        default=[], description='custom connector parameters', title='Customproperties'
    )
...
class UpdatePrivilegeRequestSchema(BaseModel):
    ...
    type: Optional[PrivilegeType] = Field(
        default=None,
        description='This Field is depreciated. Please use privilegeType Field instead.\n\nThe "canonical" privilege types that are supported by Authomize off-the-shelf:\n\nPermitted values: \n   •\t`Administrative`\n   •\t`Login`\n   •\t`Data Read`\n   •\t`Metadata Read`\n   •\t`Data Write`\n   •\t`Metadata Write`\n   •\t`Data Create`\n   •\t`Metadata Create`\n   •\t`Data Delete`\n   •\t`Metadata Delete`\n\n',
    )
...
class AppListSchema(BaseModel):
    ...
    data: List[AppSchema] = Field(..., title='Data')
...
class CampaignPrivilegeSchema(BaseModel):
    ...
    privilegeType: Optional[NewPrivilegeType] = Field(
        default=None,
        description='The "canonical" privilege types that are supported by Authomize off-the-shelf:\n\nPermitted values: \n   •\t`Administrative`\n   •\t`Data Read`\n   •\t`Metadata Read`\n   •\t`Data Write`\n   •\t`Metadata Write`\n   •\t`Data Create`\n   •\t`Metadata Create`\n   •\t`Data Delete`\n   •\t`Metadata Delete`\n',
    )
...
class RequestsBundleSchema(BaseModel):
    ...
    createdAt: Optional[datetime] = Field(default=None, title='Createdat')
    deleteModifiedAt: Optional[datetime] = Field(default=None, title='Deletemodifiedat')
    ...
    new_accounts_association: Optional[List[NewAccountsAssociationRequestSchema]] = (
        Field(
            default=None,
    ...
    new_groupings_association: Optional[List[NewGroupingsAssociationRequestSchema]] = (
        Field(
            default=None,
