...
#   timestamp: 2023-03-08T14:08:54+00:00
...
class RequestsBundleSchema(BaseModel):
    ...
    new_groupings: Optional[List[NewGroupingRequestSchema]] = Field(
        None,
        description='A "grouping" is any object that collects multiple accounts or other groupings and can be granted permissions.\nExamples include groups, roles on certain platforms (e.g. AWS), profiles in certain platforms (e.g. SFDC) and more.\nThe Create Grouping API is used to create groupings.\n',
        title='New Groupings',
    )
