...
#   timestamp: 2023-10-04T07:00:17+00:00
...
class DeprecatedPrivilegeType(Enum):
    Administrative = 'Administrative'
    Unknown = 'Unknown'
    Read = 'Read'
    ReadMetadata = 'ReadMetadata'
...
class UpdatePrivilegeRequestSchema(BaseModel):
    ...
    type: Optional[DeprecatedPrivilegeType] = Field(
        default=None,
...
class CampaignPrivilegeSchema(BaseModel):
    ...
    type: DeprecatedPrivilegeType = Field(
        ...,
        description='The "canonical" privilege types that are supported by Authomize off-the-shelf: **Mandatory**\n\nPermitted values: \n   •\t`Administrative`\n   •\t`Unknown`\n   •\t`Read`\n   •\t`ReadMetadata`\n   •\t`Write`\n   •\t`Create`\n   •\t`Delete`\n   •\t`Execute`\n   •\t`Enable`\n   •\t`Assign`\n   •\t`Restore`\n   •\t`Import`\n   •\t`Export`\n   •\t`Update`\n   •\t`Cancel`\n   •\t`Use`\n   •\t`Delegate`\n   •\t`Join`\n   •\t`Invite`\n   •\t`Share`\n\n',
    )
...
class AddCampaignMembershipsRequestSchema(BaseModel):
    ...
    grouping: CampaignGroupingSchema = Field(
        ..., description='The group to be reviewed.', title='Grouping'
    )
...
class AddCampaignMembershipsListRequestSchema(BaseModel):
    data: List[AddCampaignMembershipsRequestSchema] = Field(
        ...,
        description='The API is used to add all the campaign membership (such as membership in groups) that need to be reviewed and the reviewers details via API',
        max_items=1000,
        min_items=1,
        title='Data',
    )
...
class AddCampaignPermissionsListRequestSchema(BaseModel):
    data: List[AddCampaignPermissionsRequestSchema] = Field(
        ...,
        description='The API is used to add all the campaign privileges that need to be reviewed and the reviewers details via API',
        max_items=1000,
        min_items=1,
        title='Data',
    )
