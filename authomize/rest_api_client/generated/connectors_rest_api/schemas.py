...
#   timestamp: 2023-11-09T06:47:59+00:00
...
class IntegrationInternalStatus(Enum):
    archived = 'archived'
    deleted = 'deleted'
    enabled = 'enabled'
    failure = 'failure'
...
class UpdateRestApiConnectorSchema(BaseModel):
    config: Optional[Dict[str, Any]] = Field(default=None, title='Config')
    status: Optional[IntegrationInternalStatus] = None
    execution_state: Optional[ExecutionState] = None
    owner_id: Optional[str] = Field(default=None, title='Owner Id')
    display_name: Optional[str] = Field(default=None, title='Display Name')
    set_name: Optional[str] = Field(default=None, title='Set Name')
    owner_email: Optional[str] = Field(default=None, title='Owner Email')
    logo_file_name: Optional[str] = Field(default=None, title='Logo File Name')
    logo_storage_id: Optional[str] = Field(default=None, title='Logo Storage Id')
    logo_url: Optional[str] = Field(default=None, title='Logo Url')
    schedule_task_definitions: Optional[Dict[str, Any]] = Field(
        default=None, title='Schedule Task Definitions'
    )
    additional_properties: Optional[Dict[str, Any]] = Field(
        default=None, title='Additional Properties'
    )
