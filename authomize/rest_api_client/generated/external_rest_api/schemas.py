...
#   timestamp: 2023-05-17T12:51:01+00:00
...
class AssetsAppIdFilter(BaseModel):
    class Config:
        extra = Extra.forbid
...
class AssetsOriginIdFilter(BaseModel):
    class Config:
        extra = Extra.forbid
...
class AssetsUniqueIdFilter(BaseModel):
    class Config:
        extra = Extra.forbid
...
class Chainable(BaseModel):
    ...
    originId: Optional[AssetsOriginIdFilter] = Field(
        default=None, description='Origin ID of the Asset.', title='Originid'
    )
    appId: Optional[AssetsAppIdFilter] = Field(
        default=None, description='ID of the Application.', title='Appid'
    )
    uniqueId: Optional[AssetsUniqueIdFilter] = Field(
...
class IdentitiesEmailFilter(BaseModel):
    class Config:
        extra = Extra.forbid
...
class SearchIdentitiesFilterBody(BaseModel):
    ...
    email: Optional[IdentitiesEmailFilter] = Field(
        default=None, description='Email associated with Account', title='Email'
    )
