...
#   timestamp: 2023-10-23T19:24:51+00:00
...
class IncidentsPredefinedPolicyTemplateIdFilter(BaseModel):
    class Config:
        extra = Extra.forbid
...
class PolicySchema(BaseModel):
    ...
    predefinedTemplateId: str = Field(
        ..., description='Predefined Template ID', title='Predefinedtemplateid'
    )
...
class SearchIncidentsFilter(BaseModel):
    ...
    predefinedPolicyTemplateId: Optional[
        IncidentsPredefinedPolicyTemplateIdFilter
    ] = Field(
        default=None,
        description='Predefined Policy Template ID',
        title='Predefinedpolicytemplateid',
    )
