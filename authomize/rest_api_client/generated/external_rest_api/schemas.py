...
#   timestamp: 2023-08-31T09:46:23+00:00
...
class CampaignFailureType(Enum):
    CommonFailure = 'CommonFailure'
    EmptyQuery = 'EmptyQuery'
    QueryError = 'QueryError'
    EntitlementLimitExceeded = 'EntitlementLimitExceeded'
...
class CreateCampaignDiffOptions(BaseModel):
    class Config:
        extra = Extra.forbid

    excludeEntitlementsReviewedInLastDays: Optional[conint(ge=10, le=365)] = Field(
        default=None, title='Excludeentitlementsreviewedinlastdays'
    )
...
class IncludeMembershipsOptions(Enum):
    Include = 'Include'
    Exclude = 'Exclude'
    Only = 'Only'
...
class MeResponse(BaseModel):
    version: Optional[str] = Field(
        default='4.3.12', description='**version**', title='Version'
    )
...
class PreviousCampaignOptions(BaseModel):
    class Config:
        extra = Extra.forbid

    excludeReviewedEntitlements: Optional[bool] = Field(
        default=False, title='Excludereviewedentitlements'
    )
    campaignKey: Optional[str] = Field(default=None, title='Campaignkey')
...
class CampaignDiffOptions(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    previousCampaignOptions: Optional[PreviousCampaignOptions] = None


class CampaignModel(BaseModel):
    name: str = Field(..., title='Name')
    startDate: datetime = Field(..., title='Startdate')
    endDate: datetime = Field(..., title='Enddate')
    reviewerType: ReviewerType
    fallbackReviewerUserId: Optional[str] = Field(
        default=None, title='Fallbackrevieweruserid'
    )
    ownerUserId: Optional[str] = Field(default=None, title='Owneruserid')
    includeMemberships: IncludeMembershipsOptions
    templateName: Optional[str] = Field(default=None, title='Templatename')
    resourcesScopeIds: Optional[List[str]] = Field(
        default=None, title='Resourcesscopeids'
    )
    identitiesScopeId: Optional[str] = Field(default=None, title='Identitiesscopeid')
    parentIdentitiesScopeId: Optional[str] = Field(
        default=None, title='Parentidentitiesscopeid'
    )
    excludeBirthrightGroups: Optional[bool] = Field(
        default=None, title='Excludebirthrightgroups'
    )
    manualMembershipsOnly: Optional[bool] = Field(
        default=None, title='Manualmembershipsonly'
    )
    minMembershipGrantDate: Optional[datetime] = Field(
        default=None, title='Minmembershipgrantdate'
    )
    minEntitlementGrantDate: Optional[datetime] = Field(
        default=None, title='Minentitlementgrantdate'
    )
    adminPrivilegesOnly: Optional[bool] = Field(
        default=None, title='Adminprivilegesonly'
    )
    summary: Optional[Dict[str, Any]] = Field(default=None, title='Summary')
    selectedApps: Optional[List[str]] = Field(default=None, title='Selectedapps')
    createdFromCampaignDiffOptions: Optional[CampaignDiffOptions] = None
    includeIndirectGroupRelation: Optional[bool] = Field(
        default=None, title='Includeindirectgrouprelation'
    )
    includeIndirectResourceRelation: Optional[bool] = Field(
        default=None, title='Includeindirectresourcerelation'
    )
    includeFederated: Optional[bool] = Field(default=None, title='Includefederated')
    allowOwnerSelfReview: Optional[bool] = Field(
        default=None, title='Allowownerselfreview'
    )
    dynamicScopeId: Optional[str] = Field(default=None, title='Dynamicscopeid')
    status: Optional[CampaignStatus] = 'initializing'
    isDeleted: Optional[bool] = Field(default=False, title='Isdeleted')
    createdAt: Optional[datetime] = Field(default=None, title='Createdat')
    campaignDiffOptions: Optional[CampaignDiffOptions] = None
    primaryCampaignId: Optional[str] = Field(default=None, title='Primarycampaignid')
    createdByDuplicationEvent: Optional[bool] = Field(
        default=None, title='Createdbyduplicationevent'
    )
    id: str = Field(..., title='Id')
    failureType: Optional[CampaignFailureType] = None
    reviewersCompleted: Optional[bool] = Field(default=None, title='Reviewerscompleted')
...
class CreateCampaignRequestSchema(BaseModel):
    ...
    endDate: datetime = Field(..., title='Enddate')
    reviewerType: ReviewerType
    fallbackReviewerUserId: str = Field(..., title='Fallbackrevieweruserid')
    ownerUserId: Optional[str] = Field(
        default=None,
        description='Default: `UserId` connected to the current API-Token.',
        title='Owneruserid',
    )
    includeMemberships: Optional[IncludeMembershipsOptions] = Field(
        default='Exclude', title='IncludeMemberships'
    )
    templateName: Optional[str] = Field(default='Custom Campaign', title='Templatename')
    resourcesScopeIds: Optional[List[str]] = Field(
        default=None, title='Resourcesscopeids'
    )
    identitiesScopeId: Optional[str] = Field(default=None, title='Identitiesscopeid')
    ...
    summary: Optional[Dict[str, Any]] = Field(default=None, title='Summary')
    selectedApps: Optional[List[str]] = Field(default=None, title='Selectedapps')
    campaignDiffOptions: Optional[CreateCampaignDiffOptions] = None
    includeIndirectGroupRelation: Optional[bool] = Field(
        default=None, title='Includeindirectgrouprelation'
    )
    includeIndirectResourceRelation: Optional[bool] = Field(
