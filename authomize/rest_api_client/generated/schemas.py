...
#   timestamp: 2022-08-04T16:01:28+00:00
...
class NewIdentityRequestSchema(BaseModel):
    ...
    department: Optional[str] = Field(
        None, description="The identitiy's department in the organization.\n", title='Department'
    )
    ...
    manager: Optional[str] = Field(None, description='Manager', title='Manager')
    hireDate: Optional[datetime] = Field(None, description='Hire date', title='Hiredate')
    terminationDate: Optional[datetime] = Field(
        None, description='Termination date', title='Terminationdate'
    )
    description: Optional[str] = Field(
...
class RequestsBundleSchema(BaseModel):
    ...
    new_groupings_association: Optional[List[NewGroupingsAssociationRequestSchema]] = Field(
        None, description='**post_groupings association**', title='New Groupings Association'
    )
    new_assets: Optional[List[NewAssetsRequestSchema]] = Field(
        None, description='**post_assets**', title='New Assets'
    )
    ...
    new_identities: Optional[List[NewIdentityRequestSchema]] = Field(
        None, description='**Create new users.**', title='New Identities'
    )
...
class AllSchemasResponseSchema(BaseModel):
    request_bundle_schema: Optional[RequestsBundleSchema] = None
