...
#   timestamp: 2022-08-18T13:04:14+00:00
...
class NewAccountsAssociationResponseDataSchema(BaseModel):
    ...
    validTargetIds: List[str] = Field(
        ..., description='List of **valid** target grouping ids.', title='Validtargetids'
    )
    invalidSourceIds: List[str] = Field(
        ..., description='List of **invalid** source account ids.', title='Invalidsourceids'
    )
    invalidTargetIds: List[str] = Field(
        ..., description='List of **invalid** target grouping ids.', title='Invalidtargetids'
    )
...
class NewAccountsAssociationsListRequestSchema(BaseModel):
    data: List[NewAccountsAssociationRequestSchema] = Field(
        ..., description='New Accounts Associations', max_items=10000, min_items=1, title='Data'
    )
...
class NewAssetsInheritanceListRequestSchema(BaseModel):
    data: List[NewAssetInheritanceRequestSchema] = Field(
        ..., description='New Assets Inheritance', max_items=10000, min_items=1, title='Data'
    )
...
class NewAssetsInheritanceResponseDataSchema(BaseModel):
    ...
    invalidSourceIds: List[str] = Field(
        ..., description='List of **invalid** source assets ids.', title='Invalidsourceids'
    )
    invalidTargetIds: List[str] = Field(
        ..., description='List of **invalid** target assets ids.', title='Invalidtargetids'
    )
...
class NewGroupingRequestSchema(BaseModel):
    id: str = Field(..., description='Grouping IDs must be unique. **Mandatory**\n', title='Id')
    name: str = Field(
        ...,
...
class NewGroupingsAssociationResponseDataSchema(BaseModel):
    validSourceIds: List[str] = Field(
        ..., description='List of **valid** source grouping ids.', title='Validsourceids'
    )
    validTargetIds: List[str] = Field(
        ..., description='List of **valid** target grouping ids.', title='Validtargetids'
    )
    invalidSourceIds: List[str] = Field(
        ..., description='List of **invalid** source grouping ids.', title='Invalidsourceids'
    )
    invalidTargetIds: List[str] = Field(
        ..., description='List of **invalid** target grouping ids.', title='Invalidtargetids'
    )
...
class NewGroupingsAssociationsListRequestSchema(BaseModel):
    data: List[NewGroupingsAssociationRequestSchema] = Field(
        ..., description='New Groupings Associations', max_items=10000, min_items=1, title='Data'
    )
...
class NewPermissionRequestSchema(BaseModel):
    accountId: Optional[str] = Field(
        None,
        description='The ID of the account as the source of the permission.\n\nEther or both `accountId` / `groupingId` **must** be provided.',
        title='Accountid',
    )
    groupingId: Optional[str] = Field(
        None,
        description='The ID of the grouping as the source of the permission.\n\nEther or both `accountId` / `groupingId` **must** be provided.',
        title='Groupingid',
    )
    privilegeId: str = Field(
        ...,
        description='The ID of the privilege, allows access to assets. This field is **Mandatory**.\n',
        title='Privilegeid',
    )
...
class NewPermissionsResponseDataSchema(BaseModel):
    validAccountIds: List[str] = Field(
        ..., description='List of **valid** account ids.', title='Validaccountids'
    )
    ...
    invalidAccountIds: List[str] = Field(
        ..., description='List of **invalid** account ids.', title='Invalidaccountids'
    )
    ...
    invalidPrivilegeIds: List[str] = Field(
        ..., description='List of **invalid** privilege ids.', title='Invalidprivilegeids'
    )
...
class NewPrivilegeGrantsResponseDataSchema(BaseModel):
    validSourceIds: List[str] = Field(
        ..., description='List of **valid** source privilege ids.', title='Validsourceids'
    )
    validTargetIds: List[str] = Field(
        ..., description='List of **valid** target privilege ids.', title='Validtargetids'
    )
    invalidSourceIds: List[str] = Field(
        ..., description='List of **invalid** source privilege ids.', title='Invalidsourceids'
    )
    invalidTargetIds: List[str] = Field(
        ..., description='List of **invalid** target privilege ids.', title='Invalidtargetids'
    )
...
class NewPrivilegesGrantsListRequestSchema(BaseModel):
    data: List[NewPrivilegeGrantsRequestSchema] = Field(
        ..., description='New Privileges Grants', max_items=10000, min_items=1, title='Data'
    )
...
class NewIdentityRequestSchema(BaseModel):
    uniqueId: str = Field(..., description='Identity ID **Mandatory**\n', title='Uniqueid')
...
class RequestsBundleSchema(BaseModel):
    ...
    new_privileges_grants: Optional[List[NewPrivilegeGrantsRequestSchema]] = Field(
        None,
        description='This API allows you to create a connection between different privileges.\n',
