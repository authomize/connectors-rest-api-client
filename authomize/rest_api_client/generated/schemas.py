...
#   timestamp: 2022-08-22T22:30:39+00:00
...
class ItemsBundleSchema(BaseModel):
    ...
    inheritanceIdentities: List[IdentitiesInheritance] = Field(
...
class NewPermissionRequestSchema(BaseModel):
    sourceUniqueId: constr(min_length=1) = Field(
        ...,
        description="The unique ID of the permission's source. Must be either `accountId` or `groupingId`. **Mandatory**.\n",
...
class NewPrivilegeRequestSchema(BaseModel):
    uniqueId: constr(min_length=1) = Field(
        ...,
        description='Privilege ID. **Mandatory, must be unique.**\n',
        title='Uniqueid',
    )
