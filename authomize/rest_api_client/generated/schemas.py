...
#   timestamp: 2023-03-21T16:36:57+00:00
...
class AccountsAssociationSchema(BaseModel):
    sourceId: constr(min_length=1) = Field(
        ..., description='Source account ID **Mandatory**', title='Sourceid'
    )
...
class AssetInheritanceSchema(BaseModel):
    sourceId: constr(min_length=1) = Field(
        ..., description='ID of the source asset. **Mandatory**', title='Sourceid'
    )
    targetId: constr(min_length=1) = Field(
        ...,
...
class GroupingsAssociationSchema(BaseModel):
    sourceId: constr(min_length=1) = Field(
        ..., description='Grouping source ID **Mandatory**', title='Sourceid'
    )
    targetId: constr(min_length=1) = Field(
        ...,
...
class NewAssetRequestSchema(BaseModel):
    uniqueId: constr(min_length=1) = Field(
        ..., description='Asset ID. **Mandatory, must be unique.**', title='Uniqueid'
    )
    ...
    href: Optional[str] = Field(
        None, description='A link to the asset in the source system.', title='Href'
    )
    owner: Optional[str] = Field(
        None, description='The owner user account ID', title='Owner'
    )
    tags: Optional[List[constr(min_length=1)]] = Field(
        None, description='Tags associated with the asset.', title='Tags'
    )
...
class NewGroupingRequestSchema(BaseModel):
    uniqueId: constr(min_length=1) = Field(
        ..., description='Grouping ID. **Mandatory, must be unique.**', title='Uniqueid'
    )
    originId: Optional[constr(min_length=1)] = Field(
        None,
    ...
    tags: Optional[List[constr(min_length=1)]] = Field(
        None, description='Tags on the access grouping.', title='Tags'
    )
...
class NewPrivilegeGrantsRequestSchema(BaseModel):
    sourceId: constr(min_length=1) = Field(
        ..., description='ID of the source privilege. **Mandatory**', title='Sourceid'
    )
    targetId: constr(min_length=1) = Field(
        ..., description='ID of the granted privilege. **Mandatory**', title='Targetid'
    )
...
class IdentitySchema(BaseModel):
    uniqueId: constr(min_length=1) = Field(
        ..., description='Identity ID **Mandatory**', title='Uniqueid'
    )
    originId: Optional[constr(min_length=1)] = Field(
        None,
    ...
    email: Optional[str] = Field(
        None, description="User's work email address.", title='Email'
    )
    personalEmail: Optional[str] = Field(
        None, description="User's personal email address.", title='Personalemail'
    )
    firstName: Optional[str] = Field(
        None, description="User's first name", title='Firstname'
    )
    lastName: Optional[str] = Field(
        None, description="The user's last name.", title='Lastname'
    )
    ...
    title: Optional[str] = Field(
        None, description="The user's job title.", title='Title'
    )
    managerId: Optional[str] = Field(
        None, description="The manager identity's ID.", title='Managerid'
    )
    ...
    description: Optional[str] = Field(
        None, description='Additional description of the identity.', title='Description'
    )
    tags: Optional[List[constr(min_length=1)]] = Field(
        None, description='One or more tags on the user account.', title='Tags'
    )
...
class NewPermissionRequestSchema(BaseModel):
    ...
    assetId: Optional[str] = Field(
        None,
        description='**NEW NEW NEW** **Deprecated** - Use `targetUniqueId` and `targetType` instead.\nIf `targetUniqueId` is set, this field gets ignored.\n\nThe ID of the asset.\nWhen both this field and `targetUniqueId` set to `null`, this is a global permission on the entire application (not just locally).',
        title='Assetid',
    )
    isRole: Optional[bool] = Field(
        False,
    ...
    tags: Optional[List[constr(min_length=1)]] = Field(
        None, description='Tags on access permissions.', title='Tags'
    )
...
class NewUserRequestSchema(BaseModel):
    ...
    name: Optional[str] = Field(
        None,
        description='**NEW NEW NEW** The full name of the user, for display purposes.',
        title='Name',
    )
    email: Optional[str] = Field(
    ...
    description: Optional[str] = Field(
        None, description='Additional description of the user.', title='Description'
    )
    isExternal: Optional[bool] = Field(
        False,
        description='**CHANGE CHANGE CHANGE** Account is external to the Organization.',
        title='Isexternal',
    )
    ...
    lastLoginAt: Optional[datetime] = Field(
        None, description='The last login date in ISO 8601 format.', title='Lastloginat'
    )
    tags: Optional[List[constr(min_length=1)]] = Field(
        None, description='One or more tags on the user account.', title='Tags'
    )
...
class RequestsBundleSchema(BaseModel):
    ...
    new_assets: Optional[List[NewAssetRequestSchema]] = Field(
        None, description='Add assets.', title='New Assets'
    )
